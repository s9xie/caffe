...
params_full = ['fc6', 'fc7', 'fc8','conv2_1']
fc_params = {pr: (net.params[pr][0].data, net.params[pr][1].data) for pr in params_full}
for fc in params_full:
    print '{} weights are {} dimensional and biases are {} dimensional'.format(fc, fc_params[fc][0].shape, fc_params[fc][1].shape)

net_full_conv = caffe.Net('../examples/fixed-point/deploy.prototxt', '../models/vgg/VGG_ILSVRC_16_layers.caffemodel')
params_full_conv = ['context_conv1_1', 'context_conv1_2', 'conv1_1','conv1_2','aug_conv2_1','conv2_2','conv3_1','conv3_2','conv3_3','conv4_1','conv4_2','conv4_3','conv5_1','conv5_2','conv5_3', 'fc6-conv', 'fc7-conv', 'voc-fc8-conv']
...
net_full_conv.save('../models/vgg/VGG_ILSVRC_16_layers_full_conv_4_by_4_link_conv2_1.caffemodel')

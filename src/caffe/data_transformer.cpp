...
//Localization aware transform
//Take a pair, return a pair for the next run
//Random cropping in both training and testing phase
#ifndef OSX
template<typename Dtype>
...
#ifndef OSX
template<typename Dtype>
void DataTransformer<Dtype>::ContextTransform(const cv::Mat& cv_img,
